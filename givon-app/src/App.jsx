...
status:"טרם פנינו", url:"https://www.ondas.com" },
  ...
  { id:"e31", tier:2, name:"Xer Technologies", flag:"🇨🇭", country:"שווייץ", poc:"To Research", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/xer-technologies/", offer:"שילוב Daya ו-Guardian Angel כפיילוד ISR בפלטפורמות Heavy-lift של Xer.", product:"Daya + Guardian Angel", fitScore:88, theme:"primes", hook:"Xer Technologies integrates heavy-lift drones for long-endurance missions across Europe. Givon's Daya payload (TRL 7) is exactly what their integrator contracts need — sensor-ready, NATO-compatible. One meeting in Düsseldorf?", reasons:["מחפשות שותפי סנסורים TRL 7","חוזים קיימים באירופה — כניסה מהירה","~50 עובדים — גמיש","ביטחון + תשתית = שוק דואלי"], status:"טרם פנינו", url:"https://www.xer-technologies.com" },

  { id:"e32", tier:1, name:"DTC — Domo Tactical Comms", flag:"🇬🇧", country:"בריטניה", poc:"To Research", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/domo-tactical-communications/", offer:"Crebain כשכבת AI מעל רשת ה-C2 של DTC — פתרון אוטונומי שלם ל-DoD.", product:"Crebain on DTC C2", fitScore:92, theme:"primes", hook:"DTC holds active DoD C2 network contracts and is actively looking for autonomous AI layers. Crebain's decentralized swarm intelligence sits perfectly on top of their mesh network. Complete solution, zero hardware change.", reasons:["חוזי DoD פעילים — כניסה מיידית","Crebain = AI layer מעל הרשת שלהם","~250 עובדים — גודל נכון","co-sell = ללא עלות פיתוח"], status:"טרם פנינו", url:"https://www.domotactical.com" },

  { id:"e33", tier:2, name:"DeltaQuad", flag:"🇳🇱", country:"הולנד", poc:"To Research", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/deltaquad/", offer:"OEM sub-contracting — Daya ו-Aerosentry כפתרון הגנה קולקטיבית על פלטפורמות DeltaQuad.", product:"Daya + Aerosentry OEM", fitScore:86, theme:"primes", hook:"DeltaQuad just received strategic investment to expand in European defense. They need OEM partners for collective defense solutions. Givon's Daya + Aerosentry is the complete package — ISR and C-UAS in one integration.", reasons:["השקעה אסטרטגית חדשה — יש תקציב","מחפשות OEM sub-contracting — מודל גבעון","~100 עובדים — גודל נכון","שוק ביטחוני אירופאי"], status:"טרם פנינו", url:"https://www.deltaquad.com" },

  { id:"e34", tier:2, name:"Anello Photonics", flag:"🇺🇸", country:"ארה״ב", poc:"To Research", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/anello-photonics/", offer:"Cyberbee + Anello IMU = פתרון ניווט GPS-denied שלם ל-Navy ו-SOCOM.", product:"Cyberbee + Anello IMU", fitScore:89, theme:"primes", hook:"Anello Photonics bridges to Navy and SOCOM navigation contracts. Cyberbee's visual navigation + Anello's IMU = complete GPS-denied solution. They're already in the room — Givon just needs to be the software layer.", reasons:["גישה ישירה ל-Navy + SOCOM","Cyberbee = visual nav — משלים ל-IMU","~80 עובדים — גודל נכון","חוזי ניווט פעילים"], status:"טרם פנינו", url:"https://www.anellophotonics.com" },

  { id:"e35", tier:2, name:"HawkEye 360 — Space RF", flag:"🇺🇸", country:"ארה״ב", poc:"John Serafini", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/hawkeye-360/", offer:"נתוני קצה מ-GuaRdF + RF מהחלל של HawkEye = תמונת מודיעין RF מלאה ל-Homeland Security.", product:"GuaRdF + Space RF Intel", fitScore:85, theme:"primes", hook:"HawkEye 360 sees RF from space — GuaRdF sees it from the ground. Together: complete RF intelligence from orbit to edge. Same Homeland Security customers, zero overlap. Co-sell opportunity.", reasons:["HawkEye = RF מהחלל","GuaRdF = RF מהקצה — משלים","~250 עובדים","Homeland Security = שוק משותף"], status:"טרם פנינו", url:"https://www.he360.com" },

  { id:"e36", tier:3, name:"Mistral Solutions", flag:"🇮🇳", country:"הודו", poc:"To Research", pocTitle:"CEO", linkedin:"https://www.linkedin.com/company/mistral-solutions/", offer:"ייצור ואינטגרציה של Aerosentry ב-Scale לשווקים מחוץ לארה״ב.", product:"Aerosentry Manufacturing Scale", fitScore:82, theme:"manufacturing", hook:"Mistral Solutions specializes in ISR electronics manufacturing and system integration. Aerosentry at scale for non-US markets — India, Southeast Asia, Gulf — needs exactly their capabilities. Sister company already proven with US DoD.", reasons:["התמחות ISR electronics","Scale ייצור מחוץ לארה״ב","חברת אחות Mistral Inc מוכחת ב-DoD","שווקים חדשים — הודו, GCC, SE Asia"], status:"טרם פנינו", url:"https://www.mistralsolutions.com" },
];
